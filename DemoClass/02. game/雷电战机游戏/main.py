...
class Boss(Sprite):
    def __init__(self,boss_img_name):
        super().__init__()
        # 加载BOSS图片
        self.image = pygame.image.load('images/'+boss_img_name+'.png').convert_alpha()
        # 转换BOSS大小
...
class Enemy(Sprite):
    def __init__(self,screen):
        ...
        self.score = 10
        # 加载子弹的图片
        self.bullet_img = pygame.image.load("images/alien_bullet.png").convert_alpha()
...
class MyHero(Sprite):
    ...
    def __init__(self,screen,size = 1):
        ...
        self.screen = screen
        # 获取整张图片
        self.image_big = pygame.image.load('images/hero.png').convert_alpha()
        ...
        #玩家所有发射子弹的集合
        self.bullets = Group()
        self.bullet_image = pygame.image.load('images/bullet_1.png').convert_alpha()
    ...
    def set_air(self, case):
        if case == 'up':
            air = pygame.image.load('images/air.png').convert_alpha()
...
# 设置游戏背景图片
# 游戏刚开始时的背景图
bg_img0 = pygame.image.load('images/start_bg.jpg').convert()
# 加载游戏开始图标
...
#  游戏进行中的背景图
bg_img1 = pygame.image.load('images/map1.jpg').convert()
bg_img2 = bg_img1.copy()
# 游戏结束时的背景图
bg_img3 = pygame.image.load('images/map3.jpg').convert()
# 加载游戏结束图标
gameover_img = pygame.image.load('images/gameover.png').convert_alpha()
# 加载游戏成功图标
gamesuccess = pygame.image.load('images/success.png').convert_alpha()
...
# air = pygame.image.load('images/air.png').convert_alpha()
# img = air.subsurface(pygame.Rect(80, 0, 50, 87))
# image_big = pygame.image.load('images/hero.png').convert_alpha()
