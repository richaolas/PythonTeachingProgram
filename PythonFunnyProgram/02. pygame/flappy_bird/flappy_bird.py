...
class Bird(object):
    ...
    def __init__(self):
        ...
        # 定义鸟的3种状态列表
        self.birdStatus = [pygame.image.load("./res/assets/1.png"),
                           pygame.image.load("./res/assets/2.png"),
...
class Pipeline(object):
    ...
    def __init__(self):
        ...
        self.pineUp = pygame.image.load("./res/assets/top.png")
        self.pineDown = pygame.image.load("./res/assets/bottom.png")
...
if __name__ == '__main__':
    ...
    while True:
        ...
        background = pygame.image.load("./res/assets/background.png")  # 加载背景图片
